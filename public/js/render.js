export const getBasicItemHTML = function (info) {
...
export const getBasicItemHTMLs = function(infos) {
    return infos.reduce((acc, cur) => {
        return acc + getBasicItemHTML(cur);
    }, "");
}

export const getBasicItemDOM = function(info) {
...
export const getBestItemHTML = function (info) {
...
export const getCarouselItemDOM = function(src) {
...
export const getCarouselBoxHTML = function () {
...
// box: 화면의 한 행
export const getBoxDOM = function() {
...
// margin: 화면 가로 여백
export const getMarginDOM = function (height) {
    const dom = document.createElement("div");
...
export const getMoreBtnDOM = function() {
    const dom = document.createElement("div");
...
export const getSubjectDOM = function(content) {
    const dom = document.createElement("div");
